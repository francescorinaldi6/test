...
public class UfficioController {
	...
	@GetMapping("/{id}/{data}/getPostiPrenotati")
	public List<Posto> getPostiPrenotati(@PathVariable("id") int id, @PathVariable("data") Date data) {
		
		return posto.getPostinonDisponibili(id, data);
	}
